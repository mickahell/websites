...
def app():
    ...
    expander_mobius = column.expander("What's about ?")
    expander_mobius.write("100k points : Coming soon : description, math equation and circuit")
    ...
    expander_eclipse = column.expander("What's about ?")
    expander_eclipse.write("100k points : Coming soon : Here put description, math equation and circuit")
    ...
    expander_comete = column.expander("What's about ?")
    expander_comete.write("100k points : Coming soon : Here put description, math equation and circuit")
    ...
    column.pyplot(eye)
    expander_eye = column.expander("What's about ?")
    expander_eye.write("100k points : Coming soon : Here put description, math equation and circuit")
    ...
    column.pyplot(foot)
    expander_foot = column.expander("What's about ?")
    expander_foot.write("100k points : Coming soon : Here put description, math equation and circuit")
